var dbProperties = {
	database: process.env.MYSQL_DB,			// название базы данных
	username: process.env.MYSQL_USER,		// имя пользователя, для которого настроены права к базе данных, 'root' задаётся по умолчанию
	password: process.env.MYSQL_PASSWORD,	// пароль пользователя, по умолчанию пароль пустой
	host: process.env.MYSQL_HOST,			// имя сервера, на котором расположена база данных
